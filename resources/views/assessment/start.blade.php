...
<div class="max-w-lg mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        @foreach([['20 Soal'],['±20 Menit'],['Video BISINDO']] as [$text])
    ...
    <div class="card mt-4">
        ...
        <ul class="space-y-2 text-xs text-slate-500">
            <li class="flex items-start gap-2"><span class="text-violet-400 font-bold mt-0.5">1.</span> Tonton video BISINDO hingga selesai sebelum menjawab.</li>
            <li class="flex items-start gap-2"><span class="text-violet-400 font-bold mt-0.5">2.</span> Baca subtitle soal yang tertera di bawah video.</li>
            <li class="flex items-start gap-2"><span class="text-violet-400 font-bold mt-0.5">3.</span> Pilih satu jawaban yang paling tepat.</li>
            <li class="flex items-start gap-2"><span class="text-violet-400 font-bold mt-0.5">4.</span> Setelah semua soal dijawab, klik tombol Selesai.</li>
            <li class="flex items-start gap-2"><span class="text-violet-400 font-bold mt-0.5">5.</span> Jawaban tidak dapat diubah setelah soal disubmit.</li>
        </ul>
    </div>
